...
import { getCameras, notifyStateChange, setCameras } from "../state.js";
...
function handleMQTTMessage(topic, payload) {
    ...
    // Check if camera should be added
    if (!excludedTopics.some((excluded) => camera.toLowerCase().includes(excluded.toLowerCase()))) {
        addCamera(camera); // Add camera internally without broadcasting
    }
    ...
    // Ignore snapshot and clip topics
